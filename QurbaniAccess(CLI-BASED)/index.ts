...
function displaymessage(){
    ...
    figlet(message,(err:string, data:string) => {
        if (err) {
...
function displaydetailsasbought(animal:string,price:number,color:string,weight:number,height:number,quality:string){
...
function displaydetailsasintendtobuy(animal:string,price:number,color:string,weight:number,height:number,quality:string){
